...
class _InstrumentListScreenState extends State<InstrumentListScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('System Instruments'),
          ...
          child: Padding(
            ...
            child: TextField(
              decoration: InputDecoration(
                hintText: 'Search all instruments...',
      ...
      child: ListTile(
        ...
        subtitle: Column(
          ...
          children: [
            ...
            Text('Owner: ${instrument.currentOwnerName}', style: const TextStyle(fontWeight: FontWeight.w600)),
